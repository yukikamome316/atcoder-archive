 ...
 * Submission URL: https://atcoder.jp/contests/abc308/submissions/43145022
 * Submitted at: 2023-07-01 22:28:36
...
int main() {
  ...
  rep(i, N) {
    score[i] = {10e15 * data[i].first / (data[i].first + data[i].second), i};
  }
