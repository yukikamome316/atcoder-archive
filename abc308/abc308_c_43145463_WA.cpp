 ...
 * Submission URL: https://atcoder.jp/contests/abc308/submissions/43145463
 * Submitted at: 2023-07-01 22:29:40
...
int main() {
  ...
  rep(i, N) {
    score[i] = {(double)data[i].first / (data[i].first + data[i].second) * 10e15, i};
  }
