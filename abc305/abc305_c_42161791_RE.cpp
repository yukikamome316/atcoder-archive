 ...
 * Submission URL: https://atcoder.jp/contests/abc305/submissions/42161791
 * Submitted at: 2023-06-10 22:30:06
...
int main() {
  ...
  if (spos.second != 0 && spos.second < W 
    && grid[spos.first][spos.second - 1] == '.'
    && grid[spos.first + 1][spos.second - 1] == '#') {
